...
\end{equation*}
which has as a natural consequence that given two sections of areas $A$ and $a$ and velocity $\vec{v}$ at $A$, then upon reaching the point where the section becomes $a$, the velocity becomes 
\begin{equation*}
...
\section{Schwartzchild criterion}
Coming soon