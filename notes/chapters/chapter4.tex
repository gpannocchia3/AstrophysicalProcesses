...
\par It is customary to bestow a name on $\sigma^{ij}$: the \emph{stress tensor}. Curiously enough, the conservation of total angular momentum implies that the the stress tensor must be \emph{symmetric}. These rather nice properties should possibly be ringing a bell. 
...
\par Initially, the blob had the same density and pressure as the surrounding fluid, respectively $\rho_{0},\,P$. After the displacement, the external fluid density and pressure are $\rho',\,P'$ which are, in principle, different from density and pressure inside the bubble, $\rho^{*},\,P^{*}$.
