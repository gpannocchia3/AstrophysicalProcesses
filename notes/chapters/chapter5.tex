...
\end{equation}
incidentally, the proportionality constant is of order unity. Note that velocity is slowing down. This can be roughly explained recalling the conservation of momentum: As the wavefront expands it "gains" more mass\,\footnote{The proper expression would probably be "entrains more material".} hence needing to slow down to conserve momentum.
...
\end{figure}
\par We can follow a similar line of reasoning and find out that the pressure of the blastwave scales as\,\footnote{It's even more simple if you recall that pressures are just energy densities. I know. It's disturbing.}
\begin{equation*}
    p \sim E_{0}R^{-3}
\end{equation*}
