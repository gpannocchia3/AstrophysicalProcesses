...
\begin{equation*}
    l_{*} = \sqrt{N}l
\end{equation*}
Said $L$ the linear dimension of the object photons are trying to "escape" from, for regions of large optical depth the number of scatterings events required to actually escape is roughly determined by setting $l_{*} \approx L$. Then $N \sim L^{2}/l^{2}$. But since the optical thickness of the medium $\tau$ is of order $L/l$, our previous results yield
\begin{equation*}
