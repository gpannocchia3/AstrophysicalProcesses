...
\end{equation}
Note that since stimulated emission is proportional to the specific intensity $I_{\nu}$ and only affects the photons along the given beam, it's not a big stretch to claim that it behaves pretty much like true absorption. We shall then define the \emph{absorption coefficient, corrected for stimulated emission} as
\begin{equation}
...
\par For those among you that, like me, were particularly invested in TV shows like \emph{X-Files} and similar, may be interested to know that one of the most likely explainations of the so-called \href{https://en.wikipedia.org/wiki/Wow!_signal}{Wow! Signal} is in fact attributed to MASER action on a Hydrogen cloud.
...
\par Unfortunately, such a transition cannot be observed in lab-experiments. The extimated half-life time of the transition from the Einstein $A$ coefficient\footnote{Remember that $A$ has the dimensions of the inverse of a time, so $\tau_{HL}\approx A^{-1}$.} is of the order of a few Myrs\footnote{That is $10^{6}$ years.}. Which means that unless you have \emph{a lot} of time to spare to fight against death, you'll probably never experience even a single one of these transitions. And that is ignoring the possibility of Hydrogen getting collisionally de-excited, which is unfathomably more probable.
...
\begin{figure}[h!]
    ...
    \caption{Sampling of the 21-cm emission line with the new Spider500 Radio telescope of the Physics Department of the University of Pisa.\\ Note how the sharp, black emission line is not centered on 1420 MHz because of the Doppler shift (see next section).\\ Credits: AMLab, Group 8, a.y. 2025/2026.}
\end{figure}
