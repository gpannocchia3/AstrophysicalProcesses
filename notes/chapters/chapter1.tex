...
\begin{figure}[h!]
	...
	\caption{Schematic geometrical representation of the system. \\Credits: G. Rybicki, A. Lightman}
\end{figure}
...
\begin{equation}
	B_{\nu}^{RJ} = \frac{2\nu^{2}}{c^{2}}kT
\end{equation}
\par Another important results is achieved in the opposite regime
\begin{equation}
	B_{\nu}^{W} = ...
\end{equation}
