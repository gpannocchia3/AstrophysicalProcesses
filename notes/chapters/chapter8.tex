...
\par Moreover, the mechanism eﬃciency increases with the BHB mass\footnote{Recall that $\bar \propto M_{1}M_{2}(M_{1}+M_{2})$, while $\tau(\bar{a})\propto \bar{a}^{-1}$.}. If
...
\par In a very Hegelian way\footnote{Or "PokéMon"-ian way, if you're more inclined towards modern times.}, seeds mainly comes in three "flavors":
\begin{itemize}
