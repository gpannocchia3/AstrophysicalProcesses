...
\par In the next sections, we'll take a closer look as to what happens when we include non-zero angular momentum into the picture.
\section{Accretion in binary systems}
Coming soon.
